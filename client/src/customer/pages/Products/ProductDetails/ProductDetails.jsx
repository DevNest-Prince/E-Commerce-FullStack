      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
        ...
        <section>
          ...
          <div className='mt-7 space-y-3'>
            <div className='flex items-center gap-4'><ShieldIcon sx={{ color: teal[400] }} /><p>Authentic & Quality Assured</p></div>
            <div className='flex items-center gap-4'><WorkspacePremiumIcon sx={{ color: teal[400] }} /><p>100% money back guarantee</p></div>
            <div className='flex items-center gap-4'><LocalShippingIcon sx={{ color: teal[400] }} /><p>Free Shipping & Returns</p></div>
            <div className='flex items-center gap-4'><Wallet sx={{ color: teal[400] }} /><p>Pay on delivery might be available</p></div>
          </div>
          ...
          <div className='mt-7 space-y-2'>
            ...
            <div className='flex items-center gap-2 w-[140px] justify-between'>
              <Button disabled={quantity === 1} onClick={() => setQuantity(quantity - 1)} variant='outlined'><RemoveIcon /></Button>
              <span className='px-3 text-lg font-semibold'>{quantity}</span>
              <Button onClick={() => setQuantity(quantity + 1)} variant='outlined'><AddIcon /></Button>
            </div>
          </div>

          {/* Actions */}
          <div className='mt-12 flex items-center gap-5'>
            <Button onClick={handleAddCart} sx={{ py: "1rem" }} variant='contained' fullWidth startIcon={<AddShoppingCartIcon />}>Add To Bag</Button>
            <Button sx={{ py: "1rem" }} variant='outlined' fullWidth startIcon={<FavoriteBorderIcon />}>Wishlist</Button>
          </div>
